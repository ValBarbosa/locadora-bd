...
public class ConsultarDVD extends javax.swing.JFrame {
 ...
 private  void AtualizaTable(){
    ...
    tabela.setValueAt(tab.getCod_filme(), i,1);
    tabela.setValueAt(tab.getPreco(), i,2);
    tabela.setValueAt(tab.getData_compra(), i,3);
    tabela.setValueAt(tab.getSituacao(), i,4);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        lista = bd.Pesquisar_Id_Filme(cod);
        DefaultTableModel tbm = (DefaultTableModel) tabela.getModel();
